...
namespace HotelAPI.Contracts
{
    public interface IOrderDetailRepository
    {
        ...
        public Task<IEnumerable<OrderDetail>> GetOrderDetail(String oid);

        //批次新增OrderDetail資料
        public Task CreateMultipleOrderDetails(List<OrderDetailForCreationDto> orderDetails);

        //批次修改指定ID的OrderDetail資料
        public Task UpdateMultipleOrderDetails(String oid, List<OrderDetailForUpdateDto> orderDetails);
